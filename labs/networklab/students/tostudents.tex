...
\pagestyle{fancy}
\lhead{\bf \large{ Network Programming Lab}}
\rhead{\bf \large{ /*Mohammed Farhan -S7 CS*/}}
...
\lstinputlisting{./programs/complex.java}
\subsection*{Output}
\begin{lstlisting}
...
\lstinputlisting{./programs/string.java}
\subsection*{Output}
\begin{lstlisting}
...
\lstinputlisting{./programs/thread.java}
\subsection*{Output}
\begin{lstlisting}
